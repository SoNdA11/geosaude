...
const DetailsScreen = ({ selectedUnit, setView, user }) => {
    ...
    <div className="min-h-screen bg-gray-50 pb-10">
      <div className="max-w-6xl mx-auto p-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-3 mb-2">
            <button onClick={() => setView(user ? (user.role === 'system_admin' ? 'admin_system' : 'home') : 'home')} className="text-emerald-600 flex items-center gap-1 hover:underline">
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-[60]">
            <div className="bg-white p-6 rounded-lg shadow-xl w-96 animate-fade-in">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => { setEvalModalOpen(false); alert("Avaliação enviada!"); }} className="flex-1 bg-emerald-600 text-white py-2 rounded">Enviar</button>
              </div>
            </div>
          </div>
      )}
